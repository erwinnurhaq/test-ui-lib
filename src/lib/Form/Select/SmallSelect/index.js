...
/**
 * @type React.FC<SmallSelectProps>
 */
const SmallSelect = React.forwardRef((props, ref) => {
  const {
    label,
    testId,
    className,
  ...
  return (
    <div
      className={combineClassNames(
        'psui-select-container psui-select-container-small',
    ...
    >
      ...
      {label && (
        <label
          htmlFor={id}
          className={combineClassNames(
            'psui-type-label psui-select-label',
      ...
      <div
        className={combineClassNames(
          'psui-select-wrapper psui-select-wrapper-small',
      ...
      >
        <select
          ref={ref}
          data-testid={testId}
          className="psui-type-label psui-select-common psui-select-small"
          id={id}
          name={name}
          value={value}
          disabled={disabled}
...
SmallSelect.propTypes = SmallSelectProps;
